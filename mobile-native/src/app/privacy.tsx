...
/** 隐私政策（内容与 Web /privacy 一致） */
export default function PrivacyScreen() {
  return (
    <LegalDoc
      title="隐私政策"
      updatedAt="更新日期：2026 年 8 月 3 日"
      intro="「只有猫」（CATSJUST）重视您的隐私。本政策说明我们如何收集、使用、存储和保护您的个人信息。您使用本平台即表示您同意本政策所述的处理方式。"
      sections={[
        {
          title: '一、我们收集的信息',
          body: [
        ...
        {
          title: '七、未成年人保护',
          body: ['本平台主要面向成年人。若您为未成年人，请在监护人指导下使用本平台。'],
        },
        {
          title: '八、政策的更新',
          body: ['我们可能适时更新本政策，更新后将在平台公布。重大变更将尽可能通过显著方式通知您。'],
        },
        {
          title: '九、联系我们',
